  ...
  return (
    <div className='flex flex-col gap-4 h-full justify-center md:text-left 
     sm:text-center md:mr-5'>
        ...
        whileInView="show"
        viewport={{ once: false, amount: 0 }}
        className='md:text-[2.8 rem] lg:text-6xl sm:4xl font-bold 
         font-special text-orange'>Sujeet Kumar Gupta</motion.h1>
        ...
        <br /> 
        I create engaging websites that seamlessly blend with functionality."</motion.p>
    </div>
  )
}
